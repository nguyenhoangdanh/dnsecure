 ...
 */
export const logout = (options?: { reason?: string; allDevices?: boolean; silent?: boolean }) => (dispatch: AppDispatch) => {
...
//     type: 'SETUP_TWO_FACTOR_REQUEST'
//   });
  
//   export const verifyTwoFactorSetup = (code: string) => ({
//     type: 'VERIFY_TWO_FACTOR_SETUP_REQUEST',
//     payload: { code }
//   });
  
//   export const verifyTwoFactor = (data: VerifyTwoFactorData) => ({
//     type: 'VERIFY_TWO_FACTOR_REQUEST',
//     payload: data
//   });